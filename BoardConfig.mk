...
# Kernel
TARGET_KERNEL_CONFIG := H110_defconfig
...
BOARD_VENDORIMAGE_PARTITION_SIZE := 0x7A057000
...
TW_DEVICE_VERSION := $(shell date -u +"%Y%m%d"-"XingKongTanSuo")
